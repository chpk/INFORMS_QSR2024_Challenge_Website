...
from database import add_userdata, login_user, create_table
...
def display_home_page():
    ...
    with col1:
        ...
        if st.button('Download Dataset'):
            webbrowser.open_new_tab("https://virginiatech-my.sharepoint.com/:f:/r/personal/cpremithkumar_vt_edu/Documents/INFORMS_QSR_Challenge_training_data?csf=1&web=1&e=BSBbgQ")
